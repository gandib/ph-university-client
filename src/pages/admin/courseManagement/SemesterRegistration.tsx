...
const SemesterRegistration = () => {
  const [addSemester] = courseManagementApi.useAddRegisteredSemesterMutation();

  const { data: academcicSemester } =
    academicManagementApi.useGetAllSemestersQuery([
      { name: "sort", value: "-year" },
    ]);
  const academicSemesterOptions = academcicSemester?.data?.map((item) => ({
    value: item._id,
